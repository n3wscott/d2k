...
<g transform="rotate({{ .rotate }} 320 250)">
...
<g mask="url(#hair-mask)">
  <g id="spirals" transform="translate(320,250) rotate({{ .spin }})" style="fill:none;stroke-width:80px;stroke-linecap:round;">
...
func main() {
	...
	for i, r := range rotations {
		f, err := os.Create(fmt.Sprintf("brenda-%02d.svg", i))
		if err != nil {
			fmt.Printf("can't party :( %s\n\n", err)
			continue
		}
